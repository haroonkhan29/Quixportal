...
const DailyAssignment = () => {
  ...
  useEffect(() => {
    ...
    fetch("http://18.205.246.70:3001/project/getAll")
    .then((response) => response.json())
    .then((data) => {
  ...
  const deleteDeveloper = async (developerId) => {
    try {
      await fetch(`http://18.205.246.70:3001/developer/${developerId}`, {
        method: "DELETE",
        headers: {
  ...
  const deleteProject = async (projectId) => {
    try {
      await fetch(`http://18.205.246.70:3001/project/${projectId}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch("http://18.205.246.70:3001/developer/create", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      await fetch("http://18.205.246.70:3001/project/create", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      const response = await fetch("http://18.205.246.70:3001/dailyAssignment/create", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
