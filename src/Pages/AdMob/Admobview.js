...
const Admobview = () => {
  ...
  const handleView = (data) => {
    ...
    const images = admobData.map((item) => ({
      id: item._id,
      imageSrc: `http://18.205.246.70:3001/uploads/${item.profilePic}`,
      date: item.date,
  ...
  const handleDelete = async (index, id) => {
    try {
      await axios.delete(`http://18.205.246.70:3001/admob/${id}`);
  ...
  const fetchData = async (formattedDate) => {
    try {
      const apiUrl = "http://18.205.246.70:3001/admob";
          ...
          {selectedData && (
            <div className="selected">
              ...
              {selectedData.profilePic && (
                <img
                  src={`http://18.205.246.70:3001/uploads/${selectedData.profilePic}`}
                  alt="Selected"
                    ...
                    {admobData.map((data, index) => (
                      <tr key={index}>
                        ...
                        <td>
                          {data.profilePic && (
                            <img
                              src={`http://18.205.246.70:3001/uploads/${data.profilePic}`}
                              alt="Profile"
                              style={{
                                width: "50px",
                                height: "50px",
                              ...
                              onClick={() =>
                                openImageModal(
                                  `http://18.205.246.70:3001/uploads/${data.profilePic}`
                                )
                              }
                            />
                          )}
